...
urlpatterns = [
    ...
    path('admin/finance/deposits', views.Admin.Finance.Deposits.as_view(), name='admin/finance/deposits'),
    path('admin/finance/deposits/deposit', views.Admin.Finance.Deposits.Deposit.as_view(),
         name='admin/finance/deposits/deposits'),
    path('admin/finance/deposits/create', views.Admin.Finance.Deposits.Create, name='admin/finance/deposits/create'),
