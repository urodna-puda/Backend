...
urlpatterns = [
    ...
    path('director/finance/deposits/deposit', views.Director.Finance.Deposits.Deposit.as_view(),
         name='director/finance/deposits/deposits'),
    path('director/finance/deposits/create', views.Director.Finance.Deposits.Create, name='director/finance/deposits/create'),
